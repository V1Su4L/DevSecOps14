...
foods = [{'id': 1, 'name': 'jahnoon', 'score': 6, 'calories': 400}, {'id': 2, 'name': 'shawarma', 'score': 9, 'calories': 2000}, {
    'id': 3, 'name': 'T-bone', 'score': 10, 'calories': 500}, {'id': 4, 'name': 'tofu salad', 'score': 1, 'calories': 19}]
...
app.run(port=4999)  # os.environ.get('PORT'))
